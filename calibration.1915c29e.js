...
if(isHovered){
compassCtx.fillStyle='rgba(241,196,15,0.5)';
}else if(isSelected){
compassCtx.fillStyle='rgba(52,152,219,0.5)';
}else{
...
(function(){
const bd=document.getElementById('calibrateBackdrop');
