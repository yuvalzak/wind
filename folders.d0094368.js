...
function buildFoldersUI() {
  ...
  for (const gName of groupNames) {
    ...
    // Check if folder has wave calibration
    ...
    // Folder calibrate button — open settings folders tab
    ...
    if (folderCalibrateBtn) {
      folderCalibrateBtn.addEventListener('click', (e) => {
        ...
        // Scroll to that folder's calibration card after a short delay
        setTimeout(() => {
    ...
    // Folder delete button — archive to history
    ...
    orderedSpots.forEach((loc) => {
      ...
      // Check if spot has calibration rules (wind or wave)
