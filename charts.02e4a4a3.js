...
function drawDay(dayObj) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    // Skip first 2 and last 2 hours in direction row to make space for labels
    if (i < 2 || i >= data.length - 2) {
      dRow.insertAdjacentHTML('beforeend', `<div class="direction-item" style="width:${calculatedItemW}px"></div>`);
    } else {
