...
const heightScore=10/(1+Math.pow(waveHeight/0.3,1.8));
const periodMod=Math.max(0.4,Math.min(1.3,0.4+(wavePeriod/12.0)));
return Math.min(10,Math.max(0,heightScore*periodMod)).toFixed(1);
}
